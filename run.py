...
class Ships:
    ...
    def get_player_input(self):
        try:
            ...
            while x_row not in list(["1", "2", "3", "4", "5"]):
            ...
            while y_column not in list(["A", "B", "C", "D", "E"]):
                print("Not a valid choice, please choose A, B, C, D, or E")
                y_column = (input("Enter the column letter of the ship: \n")
                            .upper())
            return int(x_row) - 1, get_letters_to_numbers()[y_column]
...
def new_game():
    ...
    print(f"Number of enemy ships: {num_ships}")
    print("Happy hunting!")
    print("≈" * 30)
